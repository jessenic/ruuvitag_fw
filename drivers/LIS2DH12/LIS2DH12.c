...
typedef union
{
	...
	uint16_t  raw;
} LIS2DH_RAW_CONVERTER_T;


/** Structure containing sensor data for all 3 axis */
typedef struct
{
	LIS2DH_RAW_CONVERTER_T x;
	LIS2DH_RAW_CONVERTER_T y;
	LIS2DH_RAW_CONVERTER_T z;
} acceleration_t;
...
extern LIS2DH12_Ret LIS2DH12_getXmG(int32_t* const accX)
{
	...
	{
		*accX = g_sensorData.sensor.x.normalPower.value;
	}
...
extern LIS2DH12_Ret LIS2DH12_getYmG(int32_t* const accY)
{
	...
	{
		*accY = g_sensorData.sensor.y.normalPower.value;
	}
...
extern LIS2DH12_Ret LIS2DH12_getZmG(int32_t* const accZ)
{
	...
	{
		*accZ = g_sensorData.sensor.z.normalPower.value;
	}

	return retVal;
}

extern LIS2DH12_Ret LIS2DH12_getALLmG(int16_t* const accX, int16_t* const accY, int16_t* const accZ)
{
	LIS2DH12_Ret retVal = LIS2DH12_RET_OK;
	...
	{
		gpiote_event_handler(0, 0);
		*accX = g_sensorData.sensor.x.highPower.value;
		*accY = g_sensorData.sensor.y.highPower.value;
		*accZ = g_sensorData.sensor.z.highPower.value;
	}
